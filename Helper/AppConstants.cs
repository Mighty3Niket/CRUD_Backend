namespace CRUDAPI.Helper
{
    ...
    {
        public const string User_Got = "Got all users successfully.";
        public const string User_Added = "User is added successfully.";
        public const string User_Updated = "User is updated successfully.";
        public const string User_Deleted = "User is deleted successfully.";
        public const string User_Soft_Deleted = "User is soft-deleted successfully.";
        public const string Post_Got = "Got all posts successfully.";
        public const string Post_Added = "Post is added successfully.";
        public const string Post_Updated = "Post is updated successfully.";
        public const string Post_Deleted = "Post is deleted successfully.";
        public const string Post_Soft_Deleted = "Post is soft-deleted successfully.";
